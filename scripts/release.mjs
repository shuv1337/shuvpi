#!/usr/bin/env node
/**
 * Release script for shuvpi-mono
 *
 * Usage:
 ...
 * 10. Push main and the tag (CI publish-npm uses trusted publishing OIDC)
...
// 10. Push main + tag. CI (build-binaries.yml publish-npm) publishes to npm via
