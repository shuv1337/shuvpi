...
const outputPath = join(tmpdir(), "shuvpi-browser-smoke.js");
const durableOutputPath = join(tmpdir(), "shuvpi-durable-browser-smoke.js");
const agentTreeshakeOutputPath = join(tmpdir(), "shuvpi-agent-treeshake-smoke.js");
const errorLogPath = join(tmpdir(), "shuvpi-browser-smoke-errors.log");
