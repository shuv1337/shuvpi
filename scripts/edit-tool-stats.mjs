...
const DEFAULT_SESSIONS_DIR = path.join(homedir(), ".shuvpi/agent/sessions");
const DEFAULT_ACTIVE_EDIT_EXTENSION_PATH = path.join(homedir(), ".shuvpi/agent/extensions/edit.ts");
...
Options:
  --sessions-dir <path>  Sessions directory (default: ~/.shuvpi/agent/sessions)
