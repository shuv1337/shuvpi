...
const allowedExternalPackages = new Set([
	...
	"@shuv1337/shuvpi-chord/bundler",
	"@shuv1337/shuvpi-chord/context",
	"@shuv1337/shuvpi-chord/delta",
	"@shuv1337/shuvpi-chord/node",
...
function commonBuildOptions() {
	return {
		...
		banner,
		bundle: true,
		define: { SHUVPI_BUNDLED_NODE: "true" },
		external: ["@shuv1337/shuvpi-chord", "@silvia-odwyer/photon-node"],
		format: "esm",
		legalComments: "none",
		logLevel: "warning",
		metafile: true,
