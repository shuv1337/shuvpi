...
- use `shuvpi.branch.tip` and rename format-4 fields from leaf to tip rather than retain misleading new-code aliases;
...
- `docs/extensions/shuvpi-extensions-v2.md` and `docs/extensions/shuvpi-server-artifact/index.md` where examples/types use the changed surfaces;
