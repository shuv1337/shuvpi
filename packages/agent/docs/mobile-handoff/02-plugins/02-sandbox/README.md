...
**Unmodified shuvpi facet code running in a V8 isolate with no ambient authority.**
...
- `src/markdown-bundle.js` — the real shuvpi `Markdown` component, esbuild-bundled.
