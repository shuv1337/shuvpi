...
import type { Op, Path, Seg } from "@shuv1337/shuvpi-chord/delta";
...
export const PicoHarnessService = defineService<Harness>("shuvpi.harness", { local: true });
export const PicoConversationService = defineService<PicoConversationService>("shuvpi.conversation");
