import type { AssistantMessage, ToolCall } from "@shuv1337/shuvpi-ai";
					...
					return {
						...
						result:
							triggers.length > 0
								? {
										ended,
										successor: tx.createTask({ kind: "shuvpi.generation", input: { inputs: triggers } }),
									}
								: { ended },
					};
				}
