...
export function projectForkCurrentStateWrite(
	...
	if (write.namespace.startsWith("shuvpi.op.") || write.namespace.startsWith("shuvpi.pending.")) return undefined;
	if (write.namespace === "shuvpi" || write.namespace.startsWith("shuvpi.")) {
