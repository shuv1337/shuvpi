...
- run interactive coding agent session: `npx @shuv1337/pi-coding-agent`
- enter `/login` command
...
Update mom anytime with `npm install -g @shuv1337/pi-mom`. This only updates the Node.js app on your host. Anything mom installed inside the Docker container remains unchanged.
