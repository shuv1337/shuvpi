import type { Context, Session, SessionMetadata } from "@shuv1337/shuvpi-agent-core";
import { BACKGROUND_CONTEXT, MemorySessionRepo } from "@shuv1337/shuvpi-agent-core";
import type { JsonValue, ServiceCall } from "@shuv1337/shuvpi-chord";
			...
			return {
				async invokeService(call, _publish, context) {
					if (
						...
						call.serviceId === "shuvpi.session-management" &&
						call.member === "attach" &&
						call.args.length === 1 &&
