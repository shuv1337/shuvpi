import type { JsonValue, ProtocolErrorCode } from "@shuv1337/shuvpi-protocol";

export type ShuvpiServerOperationErrorCode = Extract<
	ProtocolErrorCode,
...
export class ShuvpiServerError extends Error {
	readonly code: ShuvpiServerOperationErrorCode;
	readonly details: JsonValue | undefined;

	constructor(code: ShuvpiServerOperationErrorCode, message: string, details?: JsonValue) {
		super(message);
...
export class SessionBusyError extends ShuvpiServerError {
...
export class SessionLockedError extends ShuvpiServerError {
...
export class SessionNotFoundError extends ShuvpiServerError {
...
export class NotImplementedError extends ShuvpiServerError {
	constructor() {
