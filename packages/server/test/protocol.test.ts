import type { Api, AssistantMessage, Model, ToolCall, ToolResultMessage, UserMessage } from "@shuv1337/shuvpi-ai";
import { encodeServerMessage, PROTOCOL_VERSION } from "@shuv1337/shuvpi-protocol";
...
describe("shuvpi-ai protocol bridge", () => {
