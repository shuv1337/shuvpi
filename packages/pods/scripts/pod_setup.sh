...
# Parse arguments passed from shuvpi CLI
MOUNT_COMMAND=""
MODELS_PATH=""
HF_TOKEN=""
SHUVPI_API_KEY=""
...
if [ -z "$SHUVPI_API_KEY" ]; then
    echo "ERROR: SHUVPI_API_KEY is required" >&2
    exit 1
fi
...
# --- Output GPU info for shuvpi CLI to parse -------------------------------------
echo ""
echo "===GPU_INFO_START==="
