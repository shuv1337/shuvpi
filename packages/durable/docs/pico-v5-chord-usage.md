...
import { applyImmutable } from "@shuv1337/shuvpi-chord/delta";
...
document ["s", ["message"], value]
 -> view ["s", ["docs", "shuvpi.live", "message"], value]
```

Built-in kinds and fields await approval; `shuvpi.live` is illustrative, not an available API.
