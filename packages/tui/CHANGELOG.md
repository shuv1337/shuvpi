...
- Merged upstream pi v0.85.0: fullscreen transcript controls, embedded working indicator, capability overrides, and debug/crash logging moved behind `SHUVPI_TUI_DEBUG_REDRAW` and explicit renderer options.
