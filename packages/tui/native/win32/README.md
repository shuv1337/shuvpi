...
For non-Windows cross-builds, or for custom Windows toolchains, set `SHUVPI_TUI_WIN32_TOOLCHAIN=mingw` and provide MinGW-compatible compilers:

```sh
SHUVPI_TUI_WIN32_TOOLCHAIN=mingw \
