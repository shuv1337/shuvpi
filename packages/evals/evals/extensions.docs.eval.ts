...
import { createShuvpiDocumentationEvalHarness, DOCUMENTATION_EVAL_TOOLS } from "../src/harness.ts";
			...
			await run([
				{
					type: "prompt",
					content:
						"Configure this running Shuvpi installation with an extension containing a hello tool that takes a name and returns a greeting. Do not create project source. For example, passing Bob should return `Hello, Bob!`.",
				},
				{ type: "reload" },
				{
					type: "prompt",
