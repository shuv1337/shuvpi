# @shuv1337/shuvpi-session-backend-sqlite-node

Node `node:sqlite` Session backend for `@shuv1337/shuvpi-agent-core`.

```ts
import { BACKGROUND_CONTEXT } from "@shuv1337/shuvpi-agent-core";
import {
  createNodeSqliteFactory,
  SqliteSessionRepo,
} from "@shuv1337/shuvpi-session-backend-sqlite-node";

const repository = new SqliteSessionRepo({
  directory: "/var/lib/shuvpi/sessions",
