#!/usr/bin/env bash
# Build DOOM for shuvpi-doom using doomgeneric and Emscripten
...
cp "$DOOM_DIR/doomgeneric_shuvpi.c" "$DOOM_DIR/doomgeneric/doomgeneric/"
