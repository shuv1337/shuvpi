...
Play DOOM as an overlay in shuvpi. Demonstrates that the overlay system can handle real-time game rendering at 35 FPS.

## Usage

```bash
shuvpi --extension ./examples/extensions/doom-overlay
```
...
- [shuvpi-doom](https://github.com/badlogic/shuvpi-doom) for the original Shuvpi integration
