 ...
 * Delegates to shuvpi-ai's built-in Anthropic and OpenAI streaming implementations.
 *
 * Usage:
 *   shuvpi -e ./packages/coding-agent/examples/extensions/custom-provider-gitlab-duo
...
export default function (shuvpi: ExtensionAPI) {
	shuvpi.registerProvider("gitlab-duo", {
