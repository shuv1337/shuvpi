 ...
 *
 * Usage: shuvpi --extension ./examples/extensions/overlay-test.ts
 *
...
import { CURSOR_MARKER, type Focusable, matchesKey, visibleWidth } from "@shuv1337/shuvpi-tui";

export default function (shuvpi: ExtensionAPI) {
	shuvpi.registerCommand("overlay-test", {
