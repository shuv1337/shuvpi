 ...
 * working indicator shown while shuvpi is streaming a response.
 *
 * Usage:
 *   shuvpi --extension examples/extensions/working-indicator.ts
 *
 * Commands:
 ...
 *   /working-indicator reset     Restore shuvpi's default spinner
 */

import type { ExtensionAPI, ExtensionContext, WorkingIndicatorOptions } from "@shuv1337/shuvpi-coding-agent";
...
export default function (shuvpi: ExtensionAPI) {
	...
	shuvpi.registerCommand("working-indicator", {
