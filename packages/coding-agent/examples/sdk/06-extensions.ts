...
import { createAgentSession, DefaultResourceLoader, getAgentDir, SessionManager } from "@shuv1337/shuvpi-coding-agent";
...
export default function (shuvpi: ExtensionAPI) {
	...
	// Register a command
	shuvpi.registerCommand("mycommand", {
