import type { Component, Terminal, TUI } from "@shuv1337/shuvpi-tui";
import { Container, getKeybindings, isViewportTUI, ScrollView, setKeybindings, Text } from "@shuv1337/shuvpi-tui";
