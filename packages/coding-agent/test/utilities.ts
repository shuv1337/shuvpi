...
// ============================================================================
// OAuth API key resolution from ~/.shuvpi/agent/auth.json
// ============================================================================

const AUTH_PATH = join(homedir(), ".shuvpi", "agent", "auth.json");
...
/**
 * Resolve API key for a provider from ~/.shuvpi/agent/auth.json
 *
...
/**
 * Check if a provider has credentials in ~/.shuvpi/agent/auth.json
 */
...
/**
 * Get an AuthStorage instance backed by ~/.shuvpi/agent/auth.json
