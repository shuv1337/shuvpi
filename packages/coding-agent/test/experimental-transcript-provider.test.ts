import type { AgentLane, EventListener, HarnessEvent, LaneSnapshot, WatchHandle } from "@shuv1337/shuvpi-agent-core";
import { replicatedState } from "@shuv1337/shuvpi-chord";
