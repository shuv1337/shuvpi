...
import type { AssistantMessage, Model } from "@shuv1337/pi-ai";
...
vi.mock("@shuv1337/pi-ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@shuv1337/pi-ai/compat")>();
	return {
		...actual,
