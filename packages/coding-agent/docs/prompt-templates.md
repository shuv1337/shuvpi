> shuvpi can create prompt templates. Ask it to build one for your workflow.
...
Shuvpi loads prompt templates from:

- Global: `~/.shuvpi/agent/prompts/*.md`
- Project: `.shuvpi/prompts/*.md` (only after the project is trusted)
- Packages: `prompts/` directories or `shuvpi.prompts` entries in `package.json`
