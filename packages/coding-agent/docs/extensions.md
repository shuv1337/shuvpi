...
| Package | Purpose |
|---------|---------|
| `@shuv1337/pi-coding-agent` | Extension types (`ExtensionAPI`, `ExtensionContext`, events) |
| `typebox` | Schema definitions for tool parameters |
| `@shuv1337/pi-ai` | AI utilities (`StringEnum` for Google-compatible enums) |
| `@shuv1337/pi-tui` | TUI components for custom rendering |
...
```typescript
import { isToolCallEventType } from "@shuv1337/pi-coding-agent";
...
```typescript
import { isBashToolResult } from "@shuv1337/pi-coding-agent";
...
```typescript
import { createLocalBashOperations } from "@shuv1337/pi-coding-agent";
...
```typescript
import { SessionManager } from "@shuv1337/pi-coding-agent";
...
```typescript
import { Type } from "typebox";
import { StringEnum } from "@shuv1337/pi-ai";
...
```typescript
import type { AutocompleteItem } from "@shuv1337/pi-tui";
...
```typescript
import { Box, Text } from "@shuv1337/pi-tui";
...
```typescript
import { withFileMutationQueue } from "@shuv1337/pi-coding-agent";
...
**Important:** Use `StringEnum` from `@shuv1337/pi-ai` for string enums. `Type.Union`/`Type.Literal` doesn't work with Google's API.
...
```typescript
import { createReadTool, createBashTool, type ReadOperations } from "@shuv1337/pi-coding-agent";
...
```typescript
import { keyHint } from "@shuv1337/pi-coding-agent";
...
```typescript
import { Text, Component } from "@shuv1337/pi-tui";
...
import { matchesKey } from "@shuv1337/pi-tui";
...
```typescript
import { highlightCode, getLanguageFromPath } from "@shuv1337/pi-coding-agent";
