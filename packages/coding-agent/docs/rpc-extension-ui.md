...
The exported request and response unions are defined in [`rpc-types.ts`](https://github.com/shuv1337/shuvpi/blob/main/packages/coding-agent/src/modes/rpc/rpc-types.ts). See [Extensions](extensions.md#ui-and-modes) for mode-independent extension guidance.
