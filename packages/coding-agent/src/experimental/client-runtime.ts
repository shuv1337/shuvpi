...
import { Client, ServerError } from "@shuv1337/shuvpi-client";
import { createUnixTransportFactory, discoverUnixServers, type UnixServerRoute } from "@shuv1337/shuvpi-client/unix";
...
export interface OpenClientRuntimeOptions {
	/** Directory searched when --connect is omitted. Defaults to SHUVPI_SERVER_DIR or ~/.shuvpi/server. */
