import { combineFacetLoaders, type FacetLoader, type JsonValue } from "@shuv1337/shuvpi-chord";
import {
...
const SHUVPI_PLUGIN_API = "@shuv1337/shuvpi-coding-agent/experimental/plugin";
...
function resolvePluginExternal(specifier: string): string | undefined {
	if (specifier !== SHUVPI_PLUGIN_API) return undefined;
