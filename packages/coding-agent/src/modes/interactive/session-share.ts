...
import { DEFAULT_RADIUS_GATEWAY } from "@shuv1337/shuvpi-ai/providers/radius-config";
import { type Container, type EditorComponent, hyperlink, type TUI } from "@shuv1337/shuvpi-tui";
...
/** Trailing `shuvpi.share` entry carrying the system prompt and tool schemas for the session viewer. */
