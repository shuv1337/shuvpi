 ...
 * conversation; the system messages belong to Shuvpi. An unchanged conversation keeps every
...
export class ExtensionRunner {
	 ...
	 * only and Shuvpi restores the prompt and tool state after each; `context_with_system`
