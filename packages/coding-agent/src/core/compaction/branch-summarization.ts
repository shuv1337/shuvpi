...
import type { Model, SimpleStreamOptions } from "@shuv1337/shuvpi-ai/compat";
...
export function prepareBranchEntries(entries: SessionEntry[], tokenBudget: number = 0): BranchPreparation {
	...
	// Only extract from shuvpi-generated summaries (fromHook !== true), not extension-generated ones
