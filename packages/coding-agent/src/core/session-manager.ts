import { type AgentMessage, uuidv7 } from "@shuv1337/shuvpi-agent-core";
...
export interface CompactionEntry<T = unknown> extends SessionEntryBase {
	...
	details?: T;
	/** True if generated by an extension, undefined/false if shuvpi-generated (backward compatible) */
	fromHook?: boolean;
}
...
export interface BranchSummaryEntry<T = unknown> extends SessionEntryBase {
	...
	details?: T;
	/** True if generated by an extension, false if shuvpi-generated */
	fromHook?: boolean;
}
 ...
 * Encodes cwd into a safe directory name under ~/.shuvpi/agent/sessions/.
 */
...
export class SessionManager {
	...
	setSessionFile(sessionFile: string): void {
		...
		if (existsSync(this.sessionFile)) {
			...
			// non-empty but did not parse as a shuvpi session, fail without modifying it.
			if (this.fileEntries.length === 0) {
				const explicitPath = this.sessionFile;
				if (statSync(explicitPath).size > 0) {
					throw new Error(`Session file is not a valid shuvpi session: ${explicitPath}`);
				}
				this.newSession();
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses default (~/.shuvpi/agent/sessions/<encoded-cwd>/).
	 */
