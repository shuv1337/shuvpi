    (function() {
      ...
      const injectedParams = document.querySelector('meta[name="shuvpi-url-params"]');
      ...
      function buildShareUrl(entryId) {
        ...
        const baseUrlMeta = document.querySelector('meta[name="shuvpi-share-base-url"]');
      ...
      const SIDEBAR_WIDTH_STORAGE_KEY = 'shuvpi-share:v1:sidebar-width';
