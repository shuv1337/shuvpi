...
// Classic p10k layout from powerline-footer 0.2.x (pi segment / turn_timer removed upstream).
const P10K_PRESET: PresetDef = {
  leftSegments: ["model", "thinking", "path", "git", "time_spent", "context_pct", "hostname", "extension_statuses"],
  rightSegments: [],
  secondarySegments: [],
  separator: "powerline",
...
export const PRESETS: Record<StatusLinePreset, PresetDef> = {
  // Keep default identical to p10k so upgrades don't silently change the footer.
  default: { ...P10K_PRESET },
