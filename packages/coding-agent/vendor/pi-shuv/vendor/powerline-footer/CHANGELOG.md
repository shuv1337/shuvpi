...
- **Pi 0.76 compatibility** — Verified compatibility against `@shuv1337/shuvpi-ai`, `@shuv1337/shuvpi-coding-agent`, and `@shuv1337/shuvpi-tui` `0.76.0`, then widened peer/dev ranges to `>=0.74.0 <0.77.0`.
