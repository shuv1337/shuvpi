import type { Api, AssistantMessage, Message, Model, TextContent } from "@shuv1337/shuvpi-ai";
// `complete` is not re-exported from shuvpi-ai's side-effect-free core index;
// it lives in the compat entry (upstream imported it from the pi-ai root).
import { complete } from "@shuv1337/shuvpi-ai/compat";
import { truncateAtWord } from "./utils.ts";
import { throwIfAborted } from "./abort.ts";
import type { ExtensionUIContext, ModelRegistry } from "@shuv1337/shuvpi-coding-agent";
import type {
  Client,
