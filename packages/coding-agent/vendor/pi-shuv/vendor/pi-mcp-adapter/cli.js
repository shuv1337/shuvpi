...
const AGENT_DIR = process.env.SHUVPI_CODING_AGENT_DIR?.trim()
  ? expandHome(process.env.SHUVPI_CODING_AGENT_DIR.trim())
  : path.join(HOME, ".shuvpi", "agent");
...
const PROJECT_PI_CONFIG_PATH = path.resolve(process.cwd(), ".shuvpi", "mcp.json");
