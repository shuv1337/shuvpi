...
Reusable web UI components for building AI chat interfaces powered by [@shuv1337/pi-ai](../ai) and [@shuv1337/pi-agent-core](../agent).
...
```bash
npm install @shuv1337/pi-web-ui @shuv1337/pi-agent-core @shuv1337/pi-ai
```
...
import '@shuv1337/pi-web-ui/app.css';
...
```typescript
import { defaultConvertToLlm, convertAttachments } from '@shuv1337/pi-web-ui';
...
```typescript
import { createJavaScriptReplTool } from '@shuv1337/pi-web-ui';
...
```typescript
import { createExtractDocumentTool } from '@shuv1337/pi-web-ui';
...
```typescript
import { registerToolRenderer, type ToolRenderer } from '@shuv1337/pi-web-ui';
...
```typescript
import { loadAttachment, type Attachment } from '@shuv1337/pi-web-ui';
...
```typescript
import { createStreamFn, shouldUseProxyForProvider, isCorsError } from '@shuv1337/pi-web-ui';
...
```typescript
import { SettingsDialog, ProvidersModelsTab, ProxyTab, ApiKeysTab } from '@shuv1337/pi-web-ui';
...
```typescript
import { SessionListDialog } from '@shuv1337/pi-web-ui';
...
```typescript
import { ApiKeyPromptDialog } from '@shuv1337/pi-web-ui';
...
```typescript
import { ModelSelector } from '@shuv1337/pi-web-ui';
...
```typescript
import { i18n, setLanguage, translations } from '@shuv1337/pi-web-ui';
