...
import { parseServiceCall } from "@shuv1337/shuvpi-chord";
import { ClientMessageDecoder, encodeServerMessage, PROTOCOL_VERSION } from "@shuv1337/shuvpi-protocol";
...
async function makeSocketPath(): Promise<string> {
	...
	return join(directory, "shuvpi.sock");
}
