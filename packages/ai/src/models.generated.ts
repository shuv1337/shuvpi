...
export const MODELS = {
	...
	"baseten": {
		...
		"moonshotai/Kimi-K2.5": {
			...
			provider: "baseten",
			baseUrl: "https://inference.baseten.co/v1",
			compat: {"supportsStore":false,"supportsDeveloperRole":false,"supportsReasoningEffort":false,"maxTokensField":"max_tokens","supportsStrictMode":false,"supportsLongCacheRetention":false,"thinkingFormat":"chat-template","requiresReasoningContentOnAssistantMessages":true,"chatTemplateArgs":{"enable_thinking":{"$var":"thinking.enabled"}}},
			reasoning: true,
